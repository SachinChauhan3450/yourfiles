...
export const metadata: Metadata = {
  ...
  description: 'Compress and optimize PDF documents client-side. See actual original and compressed file sizes with zero artificial stats. 100% free and local.',
  openGraph: {
