...
export const metadata: Metadata = {
  ...
  description: 'Convert JPG pictures to PDF files online in seconds. Reorder pages, customize paper orientation, and merge multiple JPGs into one PDF. 100% free.',
  openGraph: {
